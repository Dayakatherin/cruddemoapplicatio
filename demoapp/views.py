...
@csrf_exempt
def demoapp_list(request):
    if request.method == 'GET':
        demoapp = user.objects.all()
        demoapp_serializer = userSerializer(demoapp, many=True)
        return JsonResponse(demoapp_serializer.data, safe=False)
